...
class CommentDAO extends DAO 
{
    ...
    public function findAllByArticle($articleId) {
        ...
        //$sql = "SELECT usr_id,com_id,com_content FROM comment where art_id=? ";
		$stmt = $this->getDb()->prepare("SELECT usr_id,com_id,com_content FROM comment where art_id = :art_id");
		$stmt->bindValue(':art_id', $articleId);
        $stmt->execute();
